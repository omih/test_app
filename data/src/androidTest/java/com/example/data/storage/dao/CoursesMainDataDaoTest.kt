...
class CoursesMainDataDaoTest {
    companion object {
        ...
        internal val course1 = CourseMainDataEntity(1, 1, 1.11, 2, "test",
                33, 44, listOf(99, 101), "test course", "super course", null, true)
        internal val course2 = CourseMainDataEntity(2, 1000, 9.99, 9999, "test new",
    ...
    @Test
    fun testGet() {
        val courses = db.coursesMainDataDao().allCourses().blockingGet()
    ...
    @Test
    fun testDelete() {
        var courses = db.coursesMainDataDao().allCourses().blockingGet()
        assertArrayEquals(arrayOf(course1), courses.toTypedArray())

        db.coursesMainDataDao().delete(course1)
        courses = db.coursesMainDataDao().allCourses().blockingGet()
